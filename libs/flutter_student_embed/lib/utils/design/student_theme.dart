...
import 'package:flutter_student_embed/utils/design/student_color_set.dart';
...
class _StudentThemeState extends State<StudentTheme> {
  ...
  PreferredSize get _appBarDividerThemed =>
      _appBarDivider(isDarkMode ? StudentColors.oxford : StudentColors.appBarDividerLight);
  ...
  Color get onSurfaceColor => isDarkMode ? StudentColors.tiara : StudentColors.licorice;
  ...
  Color get nearSurfaceColor => isDarkMode ? Colors.grey[850] : StudentColors.porcelain;
  ...
  ThemeData _buildTheme(Color themeColor) {
    ...
    var swatch = StudentColors.makeSwatch(themeColor);
    return ThemeData(
      ...
      primaryIconTheme: IconThemeData(color: isDarkMode ? StudentColors.tiara : Colors.white),
      accentIconTheme: IconThemeData(color: isDarkMode ? Colors.black : Colors.white),
      dividerColor: isHC ? onSurfaceColor : isDarkMode ? nearSurfaceColor : StudentColors.tiara,
...
class DefaultParentTheme extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var theme = StudentTheme.of(context).defaultTheme;
